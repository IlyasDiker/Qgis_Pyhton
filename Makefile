...
SOURCES = \
	__init__.py \
	anfcc_test.py anfcc_test_dialog.py

PLUGINNAME = anfcc_test

PY_FILES = \
	__init__.py \
	anfcc_test.py anfcc_test_dialog.py

UI_FILES = anfcc_test_dialog_base.ui
...
QGISDIR=C:\Users\Ilyas\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
